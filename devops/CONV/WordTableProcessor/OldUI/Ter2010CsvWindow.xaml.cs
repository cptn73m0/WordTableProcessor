...
{
    public partial class Ter2010CsvWindow : Window
    {
        public Ter2010CsvWindow()
        {
            InitializeComponent();
        }
        ...
        private void IndexesBrowseSaveButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                Filter = "Excel Files|*.xlsx",
                FileName = $"Индексы ТЕР-2010 {DateTime.Now.ToString("MM.yyyy")}.xlsx"
            };
        ...
        private void FsscBrowseSaveButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                Filter = "Excel Files|*.xlsx",
                FileName = $"Материалы ТЕР-2010 {DateTime.Now.ToString("MM.yyyy")}.xlsx"
            };
            if (saveFileDialog.ShowDialog() == true)
            {
        ...
        private void FsemBrowseSaveButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                Filter = "Excel Files|*.xlsx",
                FileName = $"Механизмы ТЕР-2010 {DateTime.Now.ToString("MM.yyyy")}.xlsx"
            };
            if (saveFileDialog.ShowDialog() == true)
            {
