...
{
    public partial class Fer2020_0CsvWindow : Window
    {
        private IndexesSettings _indexesSettings = new IndexesSettings();

        public Fer2020_0CsvWindow()
        {
            InitializeComponent();
    ...
    public class IndexesSettings
    {
        ...
        public RegionalSettings Regional { get; set; } = new RegionalSettings();
        public IndustrySettings Industry { get; set; } = new IndustrySettings();
    ...
    public static class FrameworkElementExtensions
    {
        ...
        {
            return LogicalTreeHelper.FindLogicalNode(parent, name) as T;
        }
